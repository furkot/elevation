...
import elevationApiIo from './service/elevation-api-io/index.js';
import openElevation from './service/open-elevation/index.js';
import random from './service/random/index.js';
import tatry from './service/tatry/index.js';
import valhalla from './service/valhalla/index.js';

const defaultTimeout = 20 * 1000;

const services = {
  'elevation-api-io': elevationApiIo,
...
export default function furkotElevation(options) {
